...
const _lazy_kzMPJW = () => import('../handlers/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_kzMPJW, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_kzMPJW, lazy: true, middleware: false, method: undefined }
];
